...
// A k-d tree over a triangle mesh: median split on alternating x/y/z axes, AABB
// slab traversal. Same accelerated ray-cast interface as BVH.
class KdTree {
public:
	explicit KdTree(const std::vector<ModelTriangle> &triangles);
